...
{
    internal static unsafe void Init(this ref OBJECT_ATTRIBUTES attributes, string objectName, bool caseInsensitive = true)
    {
        ...
        var nameBuffer = Marshal.AllocHGlobal(Marshal.SizeOf<UNICODE_STRING>());
